...
{
    /// <inheritdoc />
    public partial class VersaoNova : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkingHour", x => x.WorkingHourId);
                    table.ForeignKey(
                        name: "FK_WorkingHour_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkingHour_WBS_WBSId",
                        column: x => x.WBSId,
                        principalTable: "WBS",
