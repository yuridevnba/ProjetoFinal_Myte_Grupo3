...
namespace ProjetoFinal_Myte_Grupo3.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,EmployeeName,Email,Password,HiringDate,AcessLevel,StatusEmployee")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,EmployeeName,Email,Password,HiringDate,AcessLevel,StatusEmployee")] Employee employee)
        {
